...
function countProductsByCategory() {
  ...
  document.getElementById("countCanaletas").textContent = categoryCounts.Canaletas;
  ...
  document.getElementById("countNovedades").textContent = categoryCounts.Novedades;
  document.getElementById("countTuberias").textContent = categoryCounts.Tuberias;
  ...
  document.getElementById("countCanaletasMobile").textContent = categoryCounts.Canaletas;
  ...
  document.getElementById("countNovedadesMobile").textContent = categoryCounts.Novedades;
  document.getElementById("countTuberiasMobile").textContent = categoryCounts.Tuberias;
