<header class="header">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="menu">
      ...
      <div class="container">
        <!-- Navbar brand -->
        <a class="navbar-brand" href="http://crossline.com.mx/">
          <img src="https://crossline.com.mx/Assets/logotipo_CL_blanco.svg" height="90" alt="Logo de Crossline" class="px-xl-5 px-lg-5 mt-2 logo" id="logo" loading="lazy" style="transition: all 300ms;">
        </a>
        <!-- Toggle button -->
              ...
              <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                <div class="row">
                  ...
                  <div class="col-xl-6 col-md-12 col-sm-12 menu">
                    <a href="https://crossline.com.mx//productos">
                      <li>
                    ...
                    <a href="https://crossline.com.mx//productos">
                      ...
                      </a><li class=" d-none d-sm-none d-md-none d-lg-block d-xl-block"><a href="https://crossline.com.mx//productos">
                        </a><div class="row"><a href="https://crossline.com.mx//productos">

                          </a><div class="col-1"><a href="https://crossline.com.mx//productos"></a><a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/crosslinemex" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="32" fill="currentColor" class="bi redes" viewBox="0 0 16 16">
                  ...
                  <div class="col-xl-6 col-md-0 col-sm-0 imagen-menu d-none d-sm-block d-md-block">
                    <img class="product-img" src="https://crossline.com.mx//productos/Assets/Banner_Menu_Productos.webp" alt="Fabrica de cross line">
                  </div>
                </div>
              </ul>
