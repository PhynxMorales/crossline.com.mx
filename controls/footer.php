        ...
        <div class="row mt-4 mb-4">
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            <h5 class="text-uppercase text-start mb-3">
              <img width="150" src="https://crossline.com.mx/Assets/logotipo_CL_blanco.svg" alt="Logo de crossline">
            </h5>
            <div class="col-12">
              <div class="text-footer">
                ...
                <div class="col-12 d-flex redes">
                  ...
                  <a target="_blank" class="btn btn-outline-light btn-floating m-1" href="https://www.facebook.com/crosslinemx/"
                  ...
                  <!-- Twitter -->
                  <a target="_blank" class="btn btn-outline-light btn-floating m-1" href="https://twitter.com/crosslinemx?s=11"
                    role="button">
                  ...
                  <!-- Instagram -->
                  <a target="_blank" class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/crosslinemex"
          ...
          <div class="col-lg-3 col-md-6 mb-4 mx-auto text-lg-start">
            ...
            <ul class="list-unstyled">
              <li>
                <a href="/productos.html" class="text-custom"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="modal-content">
      <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
        <video id="player" class="embed-responsive-item" controls>
          <source src="/Assets/Video Crossline.mp4" type="video/mp4">
